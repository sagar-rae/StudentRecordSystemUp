<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Teacher.aspx.cs" Inherits="StudentRecordSystem.WebForm11" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <form runat="server" class="border border-2 mt-5 p-5" style="margin: auto; width: 600px">
        <h3 class="display-5">Add Teachers</h3>
        <hr />
        <div class="container">
            <div class="row">
                <div class="col-md-6">           
                    ...
                    <label class="form-label">Select Subject:</label>
                     <asp:DropDownList CssClass="col-md-12 col-form-label rounded rounded-3" runat="server" ID="DropList2Id"></asp:DropDownList>
